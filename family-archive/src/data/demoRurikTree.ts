...
export const RURIK_FAMILY_DEMO: FamilyArchive = {
  ...
  members: [
    ...
    },
    {
      ...
      photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Svyataya_knyaginya_Olga.jpg/440px-Svyataya_knyaginya_Olga.jpg',
      photos: [],
  ...
  relations: [
    ...
    // Igor+Olga -> Svyatoslav (parent)
    { id: 'r3', fromMemberId: 'igor', toMemberId: 'svyatoslav', relationType: 'parent', createdAt: '' },
    { id: 'r4', fromMemberId: 'olga', toMemberId: 'svyatoslav', relationType: 'parent', createdAt: '' },
    ...
    // Peter1 -> Catherine2 (not blood, but successor - spouse connection)
